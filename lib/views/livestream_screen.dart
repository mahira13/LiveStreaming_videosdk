...
import 'host/host_view.dart';
import 'host/waiting_to_create_meeting.dart';
import 'viewer/viewer_view.dart';
          ...
          ? SafeArea(
              child: Scaffold(
                  ...
                  body: localParticipantMode == Mode.CONFERENCE
                      ? HostView(meeting: meeting, token: widget.token)
                      : ViewerView(
                          meeting: meeting,
                        )))
          : const WaitingToCreate(),
    );
  }
